...
export const Route = createFileRoute("/_authenticated/dashboard/community")({
  head: () => ({ meta: [{ title: "Community — Contentpreneur Africa" }] }),
  component: Community,
});
      ...
      <main className="mx-auto max-w-3xl px-4 sm:px-6 py-10">
        ...
        {q.isLoading ? (
          ...
          <div className="rounded-2xl bg-[var(--obsidian)] p-6 sm:p-8 text-center text-white mt-8">
            <div className="font-display text-4xl">$19<span className="text-[#9A9488] text-xl">/mo</span></div>
            <p className="text-[#C8C2B4] mt-2 mb-5 max-w-md mx-auto">Cancel anytime. The recurring room that keeps a one-afternoon plan (or a 12-week cohort) turning into a real business.</p>
            <a href={storeProductUrl("contentpreneur-community")} className="cta-glow inline-block">Join the Community</a>
          </div>
        )}
      </main>
      <SiteFooter />
