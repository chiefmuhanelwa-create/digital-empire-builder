...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CHKPLT — Turn What You Know Into Income You Own" },
      { name: "description", content: "CHKPLT is the home for Contentpreneurs: courses, workbooks, community, and tools to turn what you know into income you own." },
      { name: "author", content: "CHKPLT" },
      { property: "og:title", content: "CHKPLT — Turn What You Know Into Income You Own" },
      { property: "og:description", content: "The home for Contentpreneurs." },
