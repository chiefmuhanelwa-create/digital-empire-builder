...
export const TOOLS: KitTool[] = [
  ...
  { slug: "price-decision", name: "The Charge Gate", stage: 2,
    blurb: "Two questions in the right order: am I allowed to charge yet, and what is the number? Four checkable conditions, then three floors — and the highest one wins.",
    output: "A price you can defend, and the words for telling someone who has always had it free.",
    storage: "synced", key: "nochill-price-decision-v1", path: 4, readsFrom: "the-leak" },
  ...
  { slug: "4e-content-calendar", name: "The 4E Calendar", stage: 3, start: true,
    ...
    storage: "synced", key: "nochill-4e-v1", pdfKey: "4e-content-calendar", lessonSlug: "pb-3es-content-idea-formula"},
  ...
  { slug: "the-send", name: "The Send", stage: 6, start: true,
    ...
    storage: "synced", key: "nochill-the-send-v1", path: 5},
