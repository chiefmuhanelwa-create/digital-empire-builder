...
const ScriptInput = z.object({
  ...
  story: z.string().max(4000).nullish(),
  receipt: z.string().max(1000).nullish(),
  outside_voice: z.string().max(4000).nullish(),
  mechanism: z.string().max(6000).nullish(),
  cta_artifact: z.string().max(400).nullish(),
  cta_purpose: z.string().max(400).nullish(),
  generated_from: z.any().nullish(),
