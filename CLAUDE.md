...
- **Production target:** https://chkplt.com
...
- Direct. Raw. Real-talk SA energy. No sugarcoating.
- Big brother who went through it and came back with a system — not a guru, not a professor
- SA/African context first — ZAR pricing, WhatsApp commerce, Supabase/Cloudflare not AWS
- If it sounds like a LinkedIn post: rewrite it
- Never: "delve," "certainly," "I'd be happy to help," "I hope this helps"
- Always: specific ZAR amounts, specific dates, specific outcomes
- Lead with pain or the mistake — wins come after
- **Spiritual layer woven naturally** — 97% of audience is Christian. Faith = business operating system. Never performative.
- Confrontation is care: "You're not camera shy. You're clarity shy."

### Signature Phrases (Verbatim Only)
"You're too quiet." · "That's why you're broke." · "Start with your phone." · "Be fruitful. That means produce." · "You can't be shy and broke." · "Attention is better than qualification." · "Document your life." · "You understand? Because you understand." · "Skills pays more than education." · "It's bigger than me." · "Do it for your children." · "But here's the thing..." · "That's when..." · "Boom, sanamabish." · "Go create. Go produce. Go serve. Go be fruitful." · "Social media is business." · "For your children's children."
...
| MS×TS×SS | Mindset × Toolset × Skillset — all three must multiply |
| POSSESS | 7-step business GPS (Deut 1:6): Perceive Stagnation → Outline Territory → Step In → Systematise → Escalate → Scale → Secure — **ICP 1 ONLY** |
| 7-Stage Transformation | MS×TS×SS → SWOT → 4Es → Social Media → Community(3Cs) → DARES → PAIDS |
| R×A×C×U^B | Hook formula: Relevant × Awareness × Clarity × Unique^Broadened |
| 10 Shadow Fears | SF1(Wasted Life) – SF10(Legacy Void) — never name directly in copy |
...
- Always read `Learnings.md` alongside this file before starting any task
